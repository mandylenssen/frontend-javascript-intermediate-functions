...
/* 1a: Script schrijven  */
// De administratie moet weten hoeveel studenten er dit blok cum laude zijn afgestudeerd (8 of hoger). Daar moeten namelijk
// speciale diploma's voor besteld worden.
...
// Schrijf een functie genaamd cumLaude, die een array van cijfers verwacht (zoals grades) en het aantal Cum laude studenten
// teruggeeft. Gebruik hiervoor jouw antwoord van 1a.
...
function averageGrade(grades) {
    ...
    return (sum / gradesLength).toFixed(2);
}
