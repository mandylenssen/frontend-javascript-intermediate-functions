...
// getEmailDomain("a.wiersma@outlook.com") geeft novi.nl
...
/* Opdracht  2 */
// Schrijf een functie genaamd typeOfEmail, die een emailadres verwacht. De functie checkt of het emailadres een
// novi domein heeft (medewerker), een novi-education domein (student), of extern domein (zoals gmail of outlook)
// ---- Verwachte uitkomsten:
...
function checkEmailValidity(emailadres) {
    if (!emailadres.includes(",") && emailadres.includes("@") && emailadres.slice(-1) !== ".") {
        return "true";
    } else {
        return "false"
    }
